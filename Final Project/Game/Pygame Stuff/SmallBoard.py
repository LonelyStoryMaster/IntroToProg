...
class SmallBoard:
    ...
    def drawMove (self, boardRow, boardCol, Piece):
        ...
        if (Piece == 'O'):
            pygame.draw.circle (self.background, self.o_color, (centerX, centerY), int(piece_size * 2), int(self.line_weight / 1.5))
        else:
            pygame.draw.line (self.background, self.x_color, (centerX - piece_size, centerY - piece_size), \
